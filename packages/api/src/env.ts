...
const GOOGLE_STORAGE_KEYFILE_PATH = process.env.GOOGLE_STORAGE_KEYFILE_PATH;
...
if (!GOOGLE_STORAGE_KEYFILE_PATH) {
  throw new Error("GOOGLE_STORAGE_KEYFILE_PATH is not set");
}
...
const STORAGE_KEYFILE_PATH = GOOGLE_STORAGE_KEYFILE_PATH;
