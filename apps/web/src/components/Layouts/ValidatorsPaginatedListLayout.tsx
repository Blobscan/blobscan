...
export const ValidatorsPaginatedListLayout: FC<ValidatorsPaginatedListLayoutProps> = function ({
  header,
  title,
  items,
  totalItems,
  ...
  return (
    <>
      ...
      <Card
        header={
          hasItems ? (
            <div className="flex w-full flex-col items-center gap-3 text-sm md:flex-row md:justify-between" style={{ display: 'flex'}}>
                ...
                <div className="flex items-center">
                  <div>
                    <Input
                      ...
                      style={{ width: '500px', height: '36px', fontWeight: 'normal'  }}
            ...
            >
            {title && <div>{title}</div>}
            <div className=" sm:w-auto ml-auto">
              <Pagination
                selected={page}
                pages={pages}
