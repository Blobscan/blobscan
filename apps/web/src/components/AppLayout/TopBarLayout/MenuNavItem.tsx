    ...
    <Popover.Button as={Link} href={href}>
      <div
        className={`px-4 py-2 transition-all ${
          isLast && "rounded-b-lg"
        } hover:bg-primary-300 hover:text-content-light hover:dark:bg-iconHighlight-dark/80 hover:dark:text-content-dark`}
      >
        {icon}
            ...
            <>
              <Popover.Button>
                <div
                  ...
                  }  text-sm text-iconHighlight-light transition-colors`}
                >
