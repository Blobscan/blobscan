...
export const blockNumberSchema = z.coerce.number();
...
export function createCommaSeparatedParam<TSchema extends z.ZodTypeAny>(
  valueSchema: TSchema
): z.ZodEffects<
...
export const toCommaSeparatedParam = (values: string[]) => {
  return values.join(",");
};
