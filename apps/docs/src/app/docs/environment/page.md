...
| `SWARMY_STORAGE_ENABLED`                               | Store blobs in Swarmy service                                                                             | No                              | `false`                                      |
| `SWARMY_API_KEY`                                       | API key required to authenticate requests to the Swarmy service                                           | If `SWARMY_STORAGE_ENABLED=true` | (empty)                                     |
