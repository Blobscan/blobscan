...
| `SFTP_STORAGE_ENABLED`                                 | Store blobs in SFTP server                                                                                | No                                    | `false`                                      |
| `SFTP_STORAGE_HOST`                                    | SFTP server host                                                                                          | If `SFTP_STORAGE_ENABLED=true`        | (empty)                                      |
| `SFTP_STORAGE_PORT`                                    | SFTP server port                                                                                          | No                                    | `22`                                         |
| `SFTP_STORAGE_USERNAME`                                | SFTP username                                                                                             | If `SFTP_STORAGE_ENABLED=true`        | (empty)                                      |
| `SFTP_STORAGE_PASSWORD`                                | SFTP password                                                                                             | No                                    | (empty)                                      |
| `SFTP_STORAGE_PRIVATE_KEY`                             | SFTP private key                                                                                          | No                                    | (empty)                                      |
| `SFTP_STORAGE_PATH`                                    | Path on the SFTP server where blobs will be stored                                                        | If `SFTP_STORAGE_ENABLED=true`        | (empty)                                      |
| `SFTP_STORAGE_API_BASE_URL`                            | HTTP Gateway URL for accessing SFTP-stored blobs                                                          | If `SFTP_STORAGE_ENABLED=true`        | (empty)                                      |
