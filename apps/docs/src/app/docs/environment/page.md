...
| `BLOB_RECONCILIER_CRON_PATTERN`                        | Cron pattern for the blob reconcilier worker                                                              | No                              | `0 * * * *` (every 1 hour)                   |
| `BLOB_RECONCILIER_BATCH_SIZE`                          | Maximum number of blobs to process during each run                                                        | No                              | 200                                          |
